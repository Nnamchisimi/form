import { getRegistrations, findActiveRegistrationByEmail, findArchivedRegistrationByEmail, getRegistrationByReference, updateRegistrationByReference, saveRegistration, updateRegistration, archiveRegistration, deleteRegistration, getArchivedRegistrations, deleteArchivedRegistration } from './registrations';
...
export { getRegistrations, findActiveRegistrationByEmail, findArchivedRegistrationByEmail, getRegistrationByReference, updateRegistrationByReference, saveRegistration, updateRegistration, archiveRegistration, deleteRegistration, getArchivedRegistrations, deleteArchivedRegistration } from './registrations';
